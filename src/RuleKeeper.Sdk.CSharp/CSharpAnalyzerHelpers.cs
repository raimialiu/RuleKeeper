...
/// <summary>
/// Helper methods for analyzing C# code in custom rules.
/// </summary>
public static class CSharpAnalyzerHelpers
{
    /// <summary>
    /// Gets all class declarations from the syntax tree.
    /// </summary>
    public static IEnumerable<ClassDeclarationSyntax> GetClasses(this CSharpAnalysisContext context)
    {
    ...
    /// </summary>
    public static IEnumerable<MethodDeclarationSyntax> GetMethods(this CSharpAnalysisContext context)
    {
        return context.SyntaxTree.GetRoot(context.CancellationToken)
            .DescendantNodes()
    ...
    /// </summary>
    public static IEnumerable<InterfaceDeclarationSyntax> GetInterfaces(this CSharpAnalysisContext context)
    {
        return context.SyntaxTree.GetRoot(context.CancellationToken)
            .DescendantNodes()
    ...
    /// </summary>
    public static IEnumerable<PropertyDeclarationSyntax> GetProperties(this CSharpAnalysisContext context)
    {
        return context.SyntaxTree.GetRoot(context.CancellationToken)
            .DescendantNodes()
    ...
    /// </summary>
    public static IEnumerable<FieldDeclarationSyntax> GetFields(this CSharpAnalysisContext context)
    {
        return context.SyntaxTree.GetRoot(context.CancellationToken)
            .DescendantNodes()
    ...
    /// </summary>
    public static IEnumerable<InvocationExpressionSyntax> GetInvocations(this CSharpAnalysisContext context)
    {
        return context.SyntaxTree.GetRoot(context.CancellationToken)
            .DescendantNodes()
    ...
    /// </summary>
    public static ISymbol? GetSymbol(this CSharpAnalysisContext context, SyntaxNode node)
    {
    ...
    /// </summary>
    public static ITypeSymbol? GetTypeSymbol(this CSharpAnalysisContext context, SyntaxNode node)
    {
        if (context.SemanticModel == null)
            return null;
